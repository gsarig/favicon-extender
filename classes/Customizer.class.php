...
class Customizer {
	...
	public static function register( $wp_customize ) {
		...
		$wp_customize->add_control( new WP_Customize_Image_Control( $wp_customize, 'android_icon', array(
			'label'       => __( 'Mobile', 'favicon-extender' ),
			'description' => __( 'Icon for mobile screens (e.g. Android). Suggested dimension: 192x192 pixels.',
				'favicon-extender' ),
			'section'     => 'title_tagline',
			'priority'    => 100,
		...
		$wp_customize->add_control( new WP_Customize_Image_Control( $wp_customize, 'ios_icon', array(
			'label'       => __( 'iOS', 'favicon-extender' ),
			'description' => __( 'iOS devices. Suggested dimension: 180x180 pixels, no transparency.',
				'favicon-extender' ),
			'section'     => 'title_tagline',
			'priority'    => 100,
			'settings'    => 'ios_icon',
		...
		$wp_customize->add_control( new WP_Customize_Image_Control( $wp_customize, 'windows_icon', array(
			'label'       => __( 'Windows', 'favicon-extender' ),
			'description' => __( 'Icon for Windows tile. Suggested dimension: 512x512 pixels.',
				'favicon-extender' ),
			'section'     => 'title_tagline',
			'priority'    => 100,
